...
<div class="section sec1">
   <div id ="wrap" align="center">
      ...
      <input type="button" value="수정"
       ...
       onclick="open_win('ShareServlet?shareCommand=share_check_pass_form&num=${free.num}','update')">
      
      
      <input type="button" value="삭제"
       onclick="open_win('ShareServlet?shareCommand=share_check_pass_form&num=${free.num}','del')">
       </c:if>
       
      <input type="button" value="게시글 리스트" onclick="location.href='/Blog/ShareServlet?shareCommand=share_list'">
      
      <input type="button" value="글쓰기" onclick="location.href='/Blog/ShareServlet?shareCommand=share_write_form'">
   </div>
</div>
</body>
</html>